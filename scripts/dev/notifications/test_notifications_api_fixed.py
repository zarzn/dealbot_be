...
def generate_test_jwt_token(user_id="0070a2a6-0d5b-475c-abd4-906f784afc39"):
    ...
    # Create signature with CORRECT test secret key
    secret = "test_jwt_secret_key_for_testing_only"  # Fixed: using the correct test secret key
...
if __name__ == "__main__":
    print("Testing notifications API endpoint with correct JWT secret...")
